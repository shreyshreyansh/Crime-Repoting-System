...
<body>
    ...
    <div class="container">
    <div class="col-xs-6 col-xs-offset-3 login_content" style="border: 2px solid #87CEEB; margin-top: 12%; padding-bottom: 50px; color:#000; margin-bottom: 6.7%;">
            ...
            <form method="POST" action="signup_1_submit.php">
            ...
            <div class="col-xs-6" style="margin-left: 8%; margin-top: 2%;">
                <p>Already a member? <a href="login_1.php" class="hover active">Login</a></p>
            </div>
