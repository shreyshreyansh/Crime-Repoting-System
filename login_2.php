...
<body>
    ...
    <div class="col-xs-6 col-xs-offset-3 login_content" style="border: 2px solid #87CEEB; margin-top: 12%; padding-bottom: 50px; color:#000; margin-bottom: 17%;">
            ...
            <form method="POST" action="login_2_submit.php">
            ...
            <center><div style="margin-top: 13%; margin-bottom: -5%;">No Account? <a href="signup_2.php" class="hover active">Signup</a></p></div>
        </form>
		    </div>
    </div></div>
